...
const Hero = ({ handleSearch }) => {
    ...
    return (
        <div className='py-12'>
            <img src={heroImg} alt="banner" className='w-full mx-auto md:mx-w-md' />
            <div className=' text-center space-y-4'>
                <h1 className='font-thin text-7xl text-gray-900'>Browse, Search, Views, Buy</h1>
                ...
                <form onSubmit={(e)=>{
                    ...
                    // clear input state after click submit btn
                    setSearchText('');
                }}
                    ...
                    <input
                        ...
                        className='bg-white border-gray-300 shadow-md rounded w-2/4 h-5 
                    mb-3 py-6 px-4 focus:outline-none focus:shadow-outline md:mr-2 md:mb-0 ' />
